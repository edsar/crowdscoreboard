...
describe "user_reported_statistics/new" do
  before(:each) do
    assign(:user_reported_statistic, stub_model(UserReportedStatistic,
      :statistic_type => nil,
      :game => nil,
      :team_id => nil,
      :player_id => nil,
  ...
  it "renders new user_reported_statistic form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => user_reported_statistics_path, :method => "post" do
